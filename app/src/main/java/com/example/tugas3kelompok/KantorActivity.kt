...
class KantorActivity : AppCompatActivity() {
    ...
    private val categoryFilter = "Pekerjaan Kantor"
        ...
        try {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    if (isConnected) {
                        Log.d("KantorActivity", "Firebase connection successful")
                    } else {
                        Log.w("KantorActivity", "Firebase connection failed")
                        Toast.makeText(this@KantorActivity, "Koneksi Firebase gagal, aplikasi akan berjalan offline", Toast.LENGTH_LONG).show()
                    }
                } catch (e: Exception) {
                    Log.e("KantorActivity", "Error testing Firebase connection: ${e.message}", e)
                    Toast.makeText(this@KantorActivity, "Error koneksi Firebase: ${e.message}", Toast.LENGTH_LONG).show()
                }
            }
