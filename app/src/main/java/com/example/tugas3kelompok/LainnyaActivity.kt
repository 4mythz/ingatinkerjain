...
class LainnyaActivity : AppCompatActivity() {
    ...
    private val categoryFilter = "Pekerjaan Lainnya"
        ...
        try {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    if (isConnected) {
                        Log.d("LainnyaActivity", "Firebase connection successful")
                    } else {
                        Log.w("LainnyaActivity", "Firebase connection failed")
                        Toast.makeText(this@LainnyaActivity, "Koneksi Firebase gagal, aplikasi akan berjalan offline", Toast.LENGTH_LONG).show()
                    }
                } catch (e: Exception) {
                    Log.e("LainnyaActivity", "Error testing Firebase connection: ${e.message}", e)
                    Toast.makeText(this@LainnyaActivity, "Error koneksi Firebase: ${e.message}", Toast.LENGTH_LONG).show()
                }
            }
