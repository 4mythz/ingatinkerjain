...
class RumahActivity : AppCompatActivity() {
    ...
    private val categoryFilter = "Pekerjaan Rumah"
        ...
        try {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    if (isConnected) {
                        Log.d("RumahActivity", "Firebase connection successful")
                    } else {
                        Log.w("RumahActivity", "Firebase connection failed")
                        Toast.makeText(this@RumahActivity, "Koneksi Firebase gagal, aplikasi akan berjalan offline", Toast.LENGTH_LONG).show()
                    }
                } catch (e: Exception) {
                    Log.e("RumahActivity", "Error testing Firebase connection: ${e.message}", e)
                    Toast.makeText(this@RumahActivity, "Error koneksi Firebase: ${e.message}", Toast.LENGTH_LONG).show()
                }
            }
